...
import 'package:ctse_app_life_saviour/services/reminder/reminder_notification_details.dart';
...
class NotificationHelper {
  ...
  scheduledNotification(int hour, int minutes, Reminder reminder) async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
      reminder.id!,
      reminder.title,
      "Battery is less than ${reminder.remindMe.toString()}%",
  ...
  Future selectNotification(String? payload) async {
    ...
    Get.to(() => NotificationInfo(label: payload));
  }
